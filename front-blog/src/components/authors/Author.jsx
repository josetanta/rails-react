			...
			<Row className='my-3'>
							...
							<Row>
								...
								<Col sm={6}>
									<div className="text-muted">
										<small>Articulos publicados: </small><div className='badge badge-primary'>{authorArticles.length}</div>
									</div>
								</Col>
							</Row>
						</Card.Body>
				...
				<div className="border form-group my-4">
					<div className="p-2">
						...
						<ArticleForm getArticleOfAuthor={getArticleOfAuthor}></ArticleForm>
					</div>
				</div>
				...
				<Col md={6}>
					{
						authorArticles.length > 0 ? (
								...
								<Card style={{ width: '18rem' }} className="article-hover shadow mb-3" key={index}>
									<Card.Body>
