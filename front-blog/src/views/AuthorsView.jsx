...
export const AuthorsView = () => {
	...
	const deleteAutor = async autor_id => {
		await fetch(`${API_URL}/authors/${autor_id}`,{
			method: 'DELETE',
								...
								<Card.Body>
									<Row>
										<Col sm={6}>
										 	...
										 	<button className='btn-sm btn btn-danger' onClick={()=>deleteAutor(author.id)}>Eliminar este Autor</button>
										</Col>
										<Col sm={6}>
